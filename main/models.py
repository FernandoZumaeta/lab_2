...
class Localizacion(models.Model):
    ...
    def __str__(self):
        return f'{self.provincia}: {self.distrito}: {self.departamento}'
...
class Pedido(models.Model):
    ...
    repartidor = models.ForeignKey(
        'Colaborador', on_delete=models.SET_NULL, null=True)
    ubicacion = models.ForeignKey(
        'Localizacion', on_delete=models.SET_NULL, null=True)
